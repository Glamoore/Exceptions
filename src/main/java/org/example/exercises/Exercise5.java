...
public class Exercise5 {
    ...
    public static void healthInsuranceDataInput() {
        ...
        if(name.split(" ").length <= 1) {
            System.out.println("Please enter First and Surname");
        }
        // Age
        ...
        scanner.nextLine();
        if(employed && age < 16) {
            System.out.println("You cannot work below 16");
        }
        ...
        if(isStudent && employed) {
            System.out.println("You cannot be employed and a student");
        }
